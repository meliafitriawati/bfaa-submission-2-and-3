...
import com.example.githubuserapi.databinding.FragmentFollowingBinding
...
class FollowingFragment : Fragment() {
    ...
    private fun getFollowing(user: String) {
        followViewModel.getFollowing(user)
        followViewModel.following.observe(this, { following ->
            setUsers(following)
        })
